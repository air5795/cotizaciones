...
@Component({
  selector: 'app-planilla-aportes-aprobar',
  templateUrl: './planilla-aportes-aprobar.component.html',
  styleUrl: './planilla-aportes-aprobar.component.css',
  styles: [`
...
export class PlanillaAportesAprobarComponent {
